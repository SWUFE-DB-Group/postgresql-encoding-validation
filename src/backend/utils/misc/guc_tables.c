...
static const struct config_enum_entry client_message_level_options[] = {
    ...
    {"log", LOG, false},       {"info", INFO, true},
    {"notice", NOTICE, false}, {"warning", WARNING, false},
    {"error", ERROR, false},   {NULL, 0, false}};
...
StaticAssertDecl(lengthof(session_replication_role_options) ==
                     (SESSION_REPLICATION_ROLE_LOCAL + 2),
                 "array length mismatch");
...
StaticAssertDecl(lengthof(stats_fetch_consistency) ==
...
static const struct config_enum_entry huge_pages_options[] = {
    {"off", HUGE_PAGES_OFF, false},  {"on", HUGE_PAGES_ON, false},
    {"try", HUGE_PAGES_TRY, false},  {"true", HUGE_PAGES_ON, true},
    {"false", HUGE_PAGES_OFF, true}, {"yes", HUGE_PAGES_ON, true},
    {"no", HUGE_PAGES_OFF, true},    {"1", HUGE_PAGES_ON, true},
    {"0", HUGE_PAGES_OFF, true},     {NULL, 0, false}};
...
StaticAssertDecl(lengthof(ssl_protocol_versions_info) ==
                     (PG_TLS1_3_VERSION + 2),
                 "array length mismatch");
...
const char *const GucContext_Names[] = {
    [PGC_INTERNAL] = "internal", [PGC_POSTMASTER] = "postmaster",
    [PGC_SIGHUP] = "sighup",     [PGC_SU_BACKEND] = "superuser-backend",
    [PGC_BACKEND] = "backend",   [PGC_SUSET] = "superuser",
    [PGC_USERSET] = "user",
};
...
const char *const config_group_names[] = {
    ...
    [RESOURCES_WORKER_PROCESSES] =
        gettext_noop("Resource Usage / Worker Processes"),
    ...
    [COMPAT_OPTIONS_PREVIOUS] = gettext_noop(
        "Version and Platform Compatibility / Previous PostgreSQL Versions"),
    [COMPAT_OPTIONS_OTHER] = gettext_noop(
...
const char *const config_type_names[] = {
    [PGC_BOOL] = "bool",     [PGC_INT] = "integer", [PGC_REAL] = "real",
    [PGC_STRING] = "string", [PGC_ENUM] = "enum",
};
...
struct config_bool ConfigureNamesBool[] = {
    ...
    {{"enable_indexonlyscan", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables the planner's use of index-only-scan plans."), NULL,
      GUC_EXPLAIN},
    ...
    {{"enable_memoize", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables the planner's use of memoization."), NULL,
      GUC_EXPLAIN},
     &enable_memoize,
     true,
     NULL,
    ...
    {{"enable_gathermerge", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables the planner's use of gather merge plans."), NULL,
      GUC_EXPLAIN},
     &enable_gathermerge,
     true,
     NULL,
    ...
    {{"enable_partitionwise_join", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables partitionwise join."), NULL, GUC_EXPLAIN},
    ...
    {{"enable_partitionwise_aggregate", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables partitionwise aggregation and grouping."), NULL,
      GUC_EXPLAIN},
    ...
    {{"enable_parallel_append", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables the planner's use of parallel append plans."), NULL,
      GUC_EXPLAIN},
    ...
    {{"enable_parallel_hash", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables the planner's use of parallel hash plans."), NULL,
      GUC_EXPLAIN},
    ...
    {{"enable_async_append", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables the planner's use of async append plans."), NULL,
      GUC_EXPLAIN},
     &enable_async_append,
     true,
     NULL,
    ...
    {{"enable_group_by_reordering", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables reordering of GROUP BY keys."), NULL, GUC_EXPLAIN},
    ...
    {/*
     ...
     {"is_superuser", PGC_INTERNAL, UNGROUPED,
      ...
      GUC_REPORT | GUC_NO_SHOW_ALL | GUC_NO_RESET_ALL | GUC_NOT_IN_SAMPLE |
          GUC_DISALLOW_IN_FILE | GUC_ALLOW_IN_PARALLEL},
    ...
    {{"ssl_passphrase_command_supports_reload", PGC_SIGHUP, CONN_AUTH_SSL,
      gettext_noop("Controls whether \"ssl_passphrase_command\" is called "
    ...
    {{"zero_damaged_pages", PGC_SUSET, DEVELOPER_OPTIONS,
      ...
      gettext_noop(
          ...
          "report an error, aborting the current transaction. Setting "
          "\"zero_damaged_pages\" to true causes the system to instead report "
          "a "
    ...
    {{"wal_init_zero", PGC_SUSET, WAL_SETTINGS,
      gettext_noop("Writes zeroes to new WAL files before first use."), NULL},
     &wal_init_zero,
     true,
     NULL,
     NULL,
    ...
    {{"wal_recycle", PGC_SUSET, WAL_SETTINGS,
      gettext_noop("Recycles WAL files by renaming them."), NULL},
     &wal_recycle,
     true,
     NULL,
     NULL,
    ...
    {{"remove_temp_files_after_crash", PGC_SIGHUP, DEVELOPER_OPTIONS,
      gettext_noop("Remove temporary files after backend crash."), NULL,
      GUC_NOT_IN_SAMPLE},
    ...
    {{"send_abort_for_kill", PGC_SIGHUP, DEVELOPER_OPTIONS,
      gettext_noop("Send SIGABRT not SIGKILL to stuck child processes."), NULL,
      GUC_NOT_IN_SAMPLE},
     &send_abort_for_kill,
     false,
     NULL,
...
/* support for legacy compile-time setting */
    ...
    {{"debug_write_read_parse_plan_trees", PGC_SUSET, DEVELOPER_OPTIONS,
      gettext_noop(
          "Set this to force all parse and plan trees to be passed through "
          "outfuncs.c/readfuncs.c, to facilitate catching errors and omissions "
          "in "
          "those modules."),
      NULL, GUC_NOT_IN_SAMPLE},
...
/* support for legacy compile-time setting */
    ...
    {{"debug_raw_expression_coverage_test", PGC_SUSET, DEVELOPER_OPTIONS,
      gettext_noop(
          "Set this to force all raw parse trees for DML statements to be "
          "scanned "
...
/* support for legacy compile-time setting */
    ...
    {{"track_wal_io_timing", PGC_SUSET, STATS_CUMULATIVE,
      gettext_noop("Collects timing statistics for WAL I/O activity."), NULL},
     &track_wal_io_timing,
     false,
     NULL,
     NULL,
    ...
    {{"log_lock_failures", PGC_SUSET, LOGGING_WHAT,
      gettext_noop("Logs lock failures."), NULL},
     &log_lock_failures,
     false,
     NULL,
     NULL,
    ...
    {{"log_recovery_conflict_waits", PGC_SIGHUP, LOGGING_WHAT,
      gettext_noop("Logs standby recovery conflict waits."), NULL},
    ...
    {{"transaction_read_only", PGC_USERSET, CLIENT_CONN_STATEMENT,
      ...
      GUC_NO_RESET | GUC_NO_RESET_ALL | GUC_NOT_IN_SAMPLE |
    ...
    {{"optimize_bounded_sort", PGC_USERSET, QUERY_TUNING_METHOD,
      gettext_noop("Enables bounded sorting using heap sort."), NULL,
    ...
    {{"integer_datetimes", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Shows whether datetimes are integer based."), NULL,
    ...
    {{"krb_caseins_users", PGC_SIGHUP, CONN_AUTH_AUTH,
      gettext_noop("Sets whether Kerberos and GSSAPI user names should be "
    ...
    {{"synchronize_seqscans", PGC_USERSET, COMPAT_OPTIONS_PREVIOUS,
      gettext_noop("Enables synchronized sequential scans."), NULL},
    ...
    {{"recovery_target_inclusive", PGC_POSTMASTER, WAL_RECOVERY_TARGET,
      gettext_noop("Sets whether to include or exclude transaction with "
                   "recovery target."),
      NULL},
    ...
    {{"hot_standby_feedback", PGC_SIGHUP, REPLICATION_STANDBY,
      gettext_noop("Allows feedback from a hot standby to the primary that "
                   "will avoid query conflicts."),
      NULL},
    ...
    {{"in_hot_standby", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Shows whether hot standby is currently active."), NULL,
      GUC_REPORT | GUC_NOT_IN_SAMPLE | GUC_DISALLOW_IN_FILE},
     &in_hot_standby_guc,
     false,
     NULL,
    ...
    {{"data_checksums", PGC_INTERNAL, PRESET_OPTIONS,
      ...
      NULL, GUC_NOT_IN_SAMPLE | GUC_DISALLOW_IN_FILE | GUC_RUNTIME_COMPUTED},
     &data_checksums,
     false,
     NULL,
     NULL,
    ...
    {{"syslog_sequence_numbers", PGC_SIGHUP, LOGGING_WHERE,
      gettext_noop("Add sequence number to syslog messages to avoid duplicate "
                   "suppression."),
      NULL},
    ...
    {{"jit", PGC_USERSET, QUERY_TUNING_OTHER,
      gettext_noop("Allow JIT compilation."), NULL, GUC_EXPLAIN},
     &jit_enabled,
     true,
     NULL,
     NULL,
    ...
    {{"jit_debugging_support", PGC_SU_BACKEND, DEVELOPER_OPTIONS,
      gettext_noop("Register JIT-compiled functions with debugger."), NULL,
      GUC_NOT_IN_SAMPLE},
    ...
    {{"jit_dump_bitcode", PGC_SUSET, DEVELOPER_OPTIONS,
      gettext_noop("Write out LLVM bitcode to facilitate JIT debugging."), NULL,
      GUC_NOT_IN_SAMPLE},
     &jit_dump_bitcode,
     false,
     NULL,
    ...
    {{"jit_expressions", PGC_USERSET, DEVELOPER_OPTIONS,
      gettext_noop("Allow JIT compilation of expressions."), NULL,
      GUC_NOT_IN_SAMPLE},
     &jit_expressions,
     true,
     NULL,
    ...
    {{"jit_profiling_support", PGC_SU_BACKEND, DEVELOPER_OPTIONS,
      gettext_noop("Register JIT-compiled functions with perf profiler."), NULL,
      GUC_NOT_IN_SAMPLE},
    ...
    {{"jit_tuple_deforming", PGC_USERSET, DEVELOPER_OPTIONS,
      gettext_noop("Allow JIT compilation of tuple deforming."), NULL,
      GUC_NOT_IN_SAMPLE},
     &jit_tuple_deforming,
     true,
     NULL,
    ...
    {{
         ...
         gettext_noop("When enabled, event triggers will fire for all "
    ...
    {{
         ...
         PGC_SIGHUP,
         REPLICATION_STANDBY,
         gettext_noop("Enables a physical standby to synchronize logical "
                      "failover replication slots from the primary server."),
     },
     &sync_replication_slots,
     false,
     NULL,
...
struct config_int ConfigureNamesInt[] = {
    {{"archive_timeout", PGC_SIGHUP, WAL_ARCHIVING,
      ...
      gettext_noop("0 disables the timeout."), GUC_UNIT_S},
     &XLogArchiveTimeout,
     0,
     0,
     INT_MAX / 2,
    ...
    {{"geqo_pool_size", PGC_USERSET, QUERY_TUNING_GEQO,
      ...
      gettext_noop("0 means use a suitable default value."), GUC_EXPLAIN},
     &Geqo_pool_size,
     0,
     0,
     INT_MAX,
    ...
    {{"max_standby_archive_delay", PGC_SIGHUP, REPLICATION_STANDBY,
      gettext_noop("Sets the maximum delay before canceling queries when a hot "
                   "standby server is processing archived WAL data."),
      gettext_noop("-1 means wait forever."), GUC_UNIT_MS},
    ...
    {{"wal_receiver_status_interval", PGC_SIGHUP, REPLICATION_STANDBY,
      gettext_noop("Sets the maximum interval between WAL receiver status "
                   "reports to the sending server."),
      NULL, GUC_UNIT_S},
    ...
    {{"wal_receiver_timeout", PGC_SIGHUP, REPLICATION_STANDBY,
      gettext_noop("Sets the maximum wait time to receive data from the "
                   "sending server."),
      gettext_noop("0 disables the timeout."), GUC_UNIT_MS},
    ...
    {{"shared_memory_size", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Shows the size of the server's main shared memory area "
    ...
    {{"shared_memory_size_in_huge_pages", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Shows the number of huge pages needed for the main shared "
                   "memory area."),
    ...
    {{"commit_timestamp_buffers", PGC_POSTMASTER, RESOURCES_MEM,
      gettext_noop("Sets the size of the dedicated buffer pool used for the "
                   "commit timestamp cache."),
    ...
    {{"serializable_buffers", PGC_POSTMASTER, RESOURCES_MEM,
      gettext_noop("Sets the size of the dedicated buffer pool used for the "
                   "serializable transaction cache."),
      NULL, GUC_UNIT_BLOCKS},
    ...
    {{"temp_buffers", PGC_USERSET, RESOURCES_MEM,
      ...
      NULL, GUC_UNIT_BLOCKS | GUC_EXPLAIN},
     &num_temp_buffers,
     1024,
     100,
     INT_MAX / 2,
    ...
    {{"max_files_per_process", PGC_POSTMASTER, RESOURCES_KERNEL,
      gettext_noop("Sets the maximum number of files each server process is "
    ...
    {{"idle_in_transaction_session_timeout", PGC_USERSET, CLIENT_CONN_STATEMENT,
      gettext_noop("Sets the maximum allowed idle time between queries, when "
                   "in a transaction."),
      gettext_noop("0 disables the timeout."), GUC_UNIT_MS},
    ...
    {{"transaction_timeout", PGC_USERSET, CLIENT_CONN_STATEMENT,
      gettext_noop("Sets the maximum allowed duration of any transaction "
                   "within a session (not a prepared transaction)."),
      gettext_noop("0 disables the timeout."), GUC_UNIT_MS},
     &TransactionTimeout,
     0,
     0,
    ...
    {{"vacuum_multixact_freeze_min_age", PGC_USERSET, VACUUM_FREEZING,
      gettext_noop("Minimum age at which VACUUM should freeze a MultiXactId in "
                   "a table row."),
      NULL},
    ...
    {{"vacuum_multixact_freeze_table_age", PGC_USERSET, VACUUM_FREEZING,
      gettext_noop("Multixact age at which VACUUM should scan whole table to "
                   "freeze tuples."),
      NULL},
    ...
    {{"vacuum_failsafe_age", PGC_USERSET, VACUUM_FREEZING,
      gettext_noop("Age at which VACUUM should trigger failsafe to avoid a "
                   "wraparound outage."),
      NULL},
     &vacuum_failsafe_age,
     1600000000,
    ...
    {{"vacuum_multixact_failsafe_age", PGC_USERSET, VACUUM_FREEZING,
      gettext_noop("Multixact age at which VACUUM should trigger failsafe to "
    ...
    {{"max_locks_per_transaction", PGC_POSTMASTER, LOCK_MANAGEMENT,
      ...
      gettext_noop(
          ...
          "\"max_locks_per_transaction\" objects per server process or "
          "prepared "
    ...
    {{"max_pred_locks_per_transaction", PGC_POSTMASTER, LOCK_MANAGEMENT,
      ...
      gettext_noop(
          ...
          "at most \"max_pred_locks_per_transaction\" objects per server "
          "process "
    ...
    {{"max_pred_locks_per_relation", PGC_SIGHUP, LOCK_MANAGEMENT,
      gettext_noop("Sets the maximum number of predicate-locked pages and "
                   "tuples per relation."),
      gettext_noop("If more than this total of pages and tuples in the same "
                   "relation are locked "
                   "by a connection, those locks are replaced by a "
                   "relation-level lock.")},
    ...
    {{
         ...
         PGC_POSTMASTER,
         RESOURCES_DISK,
         gettext_noop("Sets the maximum number of allocated pages for NOTIFY / "
                      "LISTEN queue."),
         NULL,
     },
     &max_notify_queue_pages,
    ...
    {{"wal_decode_buffer_size", PGC_POSTMASTER, WAL_RECOVERY,
      ...
      gettext_noop("Maximum distance to read ahead in the WAL to prefetch "
    ...
    {{"checkpoint_flush_after", PGC_SIGHUP, WAL_CHECKPOINTS,
      gettext_noop("Number of pages after which previously performed writes "
                   "are flushed to disk."),
      gettext_noop("0 disables forced writeback."), GUC_UNIT_BLOCKS},
    ...
    {/* see max_wal_senders */
     {"max_replication_slots", PGC_POSTMASTER, REPLICATION_SENDING,
      gettext_noop("Sets the maximum number of simultaneously defined "
                   "replication slots."),
      NULL},
    ...
    {{"max_slot_wal_keep_size", PGC_SIGHUP, REPLICATION_SENDING,
      gettext_noop("Sets the maximum WAL size that can be reserved by "
                   "replication slots."),
      gettext_noop(
          "Replication slots will be marked as failed, and segments released "
          "for deletion or recycling, if this much space is occupied by WAL on "
          "disk. "
          "-1 means no maximum."),
      GUC_UNIT_MB},
    ...
    {{"log_min_duration_statement", PGC_SUSET, LOGGING_WHEN,
      ...
      gettext_noop("-1 disables logging statement durations. 0 means log all "
                   "statement durations."),
      GUC_UNIT_MS},
    ...
    {{"log_autovacuum_min_duration", PGC_SIGHUP, LOGGING_WHAT,
      ...
      gettext_noop("-1 disables logging autovacuum actions. 0 means log all "
                   "autovacuum actions."),
      GUC_UNIT_MS},
    ...
    {{"log_parameter_max_length", PGC_SUSET, LOGGING_WHAT,
      ...
      gettext_noop("-1 means log values in full."), GUC_UNIT_BYTE},
    ...
    {{"effective_io_concurrency", PGC_USERSET, RESOURCES_IO,
      gettext_noop("Number of simultaneous requests that can be handled "
                   "efficiently by the disk subsystem."),
      gettext_noop("0 disables simultaneous requests."), GUC_EXPLAIN},
    ...
    {{"io_max_combine_limit", PGC_POSTMASTER, RESOURCES_IO,
      gettext_noop("Server-wide limit that clamps io_combine_limit."), NULL,
      GUC_UNIT_BLOCKS},
    ...
    {{"io_combine_limit", PGC_USERSET, RESOURCES_IO,
      gettext_noop("Limit on the size of data reads and writes."), NULL,
      GUC_UNIT_BLOCKS},
    ...
    {{"wal_segment_size", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Shows the size of write ahead log segments."), NULL,
    ...
    {{"autovacuum_analyze_threshold", PGC_SIGHUP, VACUUM_AUTOVACUUM,
      gettext_noop("Minimum number of tuple inserts, updates, or deletes prior "
                   "to analyze."),
      NULL},
    ...
    {/* see varsup.c for why this is PGC_POSTMASTER not PGC_SIGHUP */
     {"autovacuum_freeze_max_age", PGC_POSTMASTER, VACUUM_AUTOVACUUM,
      gettext_noop("Age at which to autovacuum a table to prevent transaction "
                   "ID wraparound."),
      NULL},
    ...
    {/* see multixact.c for why this is PGC_POSTMASTER not PGC_SIGHUP */
     {"autovacuum_multixact_freeze_max_age", PGC_POSTMASTER, VACUUM_AUTOVACUUM,
      gettext_noop("Multixact age at which to autovacuum a table to prevent "
    ...
    {/* see max_connections */
     {"autovacuum_worker_slots", PGC_POSTMASTER, VACUUM_AUTOVACUUM,
      gettext_noop("Sets the number of backend slots to allocate for "
                   "autovacuum workers."),
      NULL},
    ...
    {{"max_parallel_maintenance_workers", PGC_USERSET,
      RESOURCES_WORKER_PROCESSES,
      gettext_noop("Sets the maximum number of parallel processes per "
    ...
    {{"max_parallel_workers", PGC_USERSET, RESOURCES_WORKER_PROCESSES,
      gettext_noop("Sets the maximum number of parallel workers that can be "
                   "active at one time."),
      NULL, GUC_EXPLAIN},
    ...
    {{"autovacuum_work_mem", PGC_SIGHUP, RESOURCES_MEM,
      gettext_noop("Sets the maximum memory to be used by each autovacuum "
                   "worker process."),
      gettext_noop("-1 means use \"maintenance_work_mem\"."), GUC_UNIT_KB},
     &autovacuum_work_mem,
     -1,
     -1,
     MAX_KILOBYTES,
    ...
    {{"tcp_keepalives_idle", PGC_USERSET, CONN_AUTH_TCP,
      ...
      gettext_noop("0 means use the system default."), GUC_UNIT_S},
     &tcp_keepalives_idle,
     0,
     0,
     INT_MAX,
    ...
    {{
         ...
         PGC_USERSET,
         QUERY_TUNING_COST,
         gettext_noop("Sets the planner's assumption about the total size of "
                      "the data caches."),
         gettext_noop(
             "That is, the total size of the caches (kernel cache and shared "
             "buffers) used for PostgreSQL data files. "
    ...
    {{
         ...
         gettext_noop("If the planner estimates that it will read a number of "
                      "table pages too small to reach this limit, a parallel "
                      "scan will not be considered."),
         GUC_UNIT_BLOCKS | GUC_EXPLAIN,
     },
     &min_parallel_table_scan_size,
     (8 * 1024 * 1024) / BLCKSZ,
    ...
    {{
         ...
         gettext_noop("If the planner estimates that it will read a number of "
                      "index pages too small to reach this limit, a parallel "
                      "scan will not be considered."),
         GUC_UNIT_BLOCKS | GUC_EXPLAIN,
     },
     &min_parallel_index_scan_size,
    ...
    {{"log_temp_files", PGC_SUSET, LOGGING_WHAT,
      gettext_noop("Log the use of temporary files larger than this number of "
                   "kilobytes."),
      gettext_noop("-1 disables logging temporary files. 0 means log all "
                   "temporary files."),
      GUC_UNIT_KB},
     &log_temp_files,
     -1,
    ...
    {{"tcp_user_timeout", PGC_USERSET, CONN_AUTH_TCP,
      ...
      gettext_noop("0 means use the system default."), GUC_UNIT_MS},
     &tcp_user_timeout,
     0,
     0,
     INT_MAX,
    ...
    {{"huge_page_size", PGC_POSTMASTER, RESOURCES_MEM,
      ...
      gettext_noop("0 means use the system default."), GUC_UNIT_KB},
     &huge_page_size,
     0,
     0,
     INT_MAX,
    ...
    {{"debug_discard_caches", PGC_SUSET, DEVELOPER_OPTIONS,
      ...
      gettext_noop("0 means use normal caching behavior."), GUC_NOT_IN_SAMPLE},
...
/* Set default based on older compile-time-only cache clobber macros */
    ...
    {{"client_connection_check_interval", PGC_USERSET, CONN_AUTH_TCP,
      gettext_noop("Sets the time interval between checks for disconnection "
                   "while running queries."),
      gettext_noop("0 disables connection checks."), GUC_UNIT_MS},
...
struct config_real ConfigureNamesReal[] = {
    ...
    {{"jit_above_cost", PGC_USERSET, QUERY_TUNING_COST,
      ...
      gettext_noop("-1 disables JIT compilation."), GUC_EXPLAIN},
     &jit_above_cost,
     100000,
     -1,
     DBL_MAX,
    ...
    {{"jit_optimize_above_cost", PGC_USERSET, QUERY_TUNING_COST,
      ...
      gettext_noop("-1 disables optimization."), GUC_EXPLAIN},
    ...
    {{"jit_inline_above_cost", PGC_USERSET, QUERY_TUNING_COST,
      ...
      gettext_noop("-1 disables inlining."), GUC_EXPLAIN},
    ...
    {{"geqo_seed", PGC_USERSET, QUERY_TUNING_GEQO,
      gettext_noop("GEQO: seed for random path selection."), NULL, GUC_EXPLAIN},
     &Geqo_seed,
     0.0,
     0.0,
     1.0,
    ...
    {{"hash_mem_multiplier", PGC_USERSET, RESOURCES_MEM,
      gettext_noop("Multiple of \"work_mem\" to use for hash tables."), NULL,
      GUC_EXPLAIN},
     &hash_mem_multiplier,
     2.0,
     1.0,
    ...
    {{"seed", PGC_USERSET, UNGROUPED,
      ...
      GUC_NO_SHOW_ALL | GUC_NO_RESET | GUC_NO_RESET_ALL | GUC_NOT_IN_SAMPLE |
          GUC_DISALLOW_IN_FILE},
     &phony_random_seed,
     0.0,
     -1.0,
    ...
    {{"autovacuum_vacuum_cost_delay", PGC_SIGHUP, VACUUM_AUTOVACUUM,
      ...
      gettext_noop("-1 means use \"vacuum_cost_delay\"."), GUC_UNIT_MS},
    ...
    {{"autovacuum_vacuum_scale_factor", PGC_SIGHUP, VACUUM_AUTOVACUUM,
      gettext_noop("Number of tuple updates or deletes prior to vacuum as a "
    ...
    {{"autovacuum_vacuum_insert_scale_factor", PGC_SIGHUP, VACUUM_AUTOVACUUM,
      gettext_noop("Number of tuple inserts prior to vacuum as a fraction of "
                   "reltuples."),
      NULL},
    ...
    {{"autovacuum_analyze_scale_factor", PGC_SIGHUP, VACUUM_AUTOVACUUM,
      gettext_noop("Number of tuple inserts, updates, or deletes prior to "
    ...
    {{"checkpoint_completion_target", PGC_SIGHUP, WAL_CHECKPOINTS,
      gettext_noop("Time spent flushing dirty buffers during checkpoint, as "
    ...
    {{"log_transaction_sample_rate", PGC_SUSET, LOGGING_WHEN,
      gettext_noop("Sets the fraction of transactions from which to log all "
                   "statements."),
    ...
    {{"vacuum_max_eager_freeze_failure_rate", PGC_USERSET, VACUUM_FREEZING,
      gettext_noop("Fraction of pages in a relation vacuum can scan and fail "
                   "to freeze before disabling eager scanning."),
      gettext_noop(
          "A value of 0.0 disables eager scanning and a value of 1.0 will "
          "eagerly scan up to 100 percent of the all-visible pages in the "
          "relation. If vacuum successfully freezes these pages, the cap is "
          "lower than 100 percent, because the goal is to amortize page "
          "freezing across multiple vacuums.")},
...
struct config_string ConfigureNamesString[] = {
    ...
    {{"restore_command", PGC_SIGHUP, WAL_ARCHIVE_RECOVERY,
      gettext_noop("Sets the shell command that will be called to retrieve an "
                   "archived WAL file."),
      NULL},
    ...
    {{"archive_cleanup_command", PGC_SIGHUP, WAL_ARCHIVE_RECOVERY,
      gettext_noop("Sets the shell command that will be executed at every "
                   "restart point."),
      NULL},
    ...
    {{"recovery_end_command", PGC_SIGHUP, WAL_ARCHIVE_RECOVERY,
      gettext_noop("Sets the shell command that will be executed once at the "
                   "end of recovery."),
      NULL},
     &recoveryEndCommand,
     "",
    ...
    {{"recovery_target_timeline", PGC_POSTMASTER, WAL_RECOVERY_TARGET,
      gettext_noop("Specifies the timeline to recover into."), NULL},
    ...
    {{"recovery_target", PGC_POSTMASTER, WAL_RECOVERY_TARGET,
      gettext_noop("Set to \"immediate\" to end recovery as soon as a "
    ...
    {{"recovery_target_lsn", PGC_POSTMASTER, WAL_RECOVERY_TARGET,
      gettext_noop("Sets the LSN of the write-ahead log location up to which "
    ...
    {{"primary_conninfo", PGC_SIGHUP, REPLICATION_STANDBY,
      gettext_noop("Sets the connection string to be used to connect to the "
                   "sending server."),
    ...
    {{"primary_slot_name", PGC_SIGHUP, REPLICATION_STANDBY,
      gettext_noop("Sets the name of the replication slot to use on the "
                   "sending server."),
      NULL},
     &PrimarySlotName,
     "",
    ...
    {{"extension_control_path", PGC_SUSET, CLIENT_CONN_OTHER,
      ...
      gettext_noop(
          "The remaining extension script and secondary control files are then "
          "loaded "
    ...
    {{"search_path", PGC_USERSET, CLIENT_CONN_STATEMENT,
      gettext_noop("Sets the schema search order for names that are not "
                   "schema-qualified."),
      NULL, GUC_LIST_INPUT | GUC_LIST_QUOTE | GUC_EXPLAIN | GUC_REPORT},
    ...
    {/* Can't be set in postgresql.conf */
     {"server_encoding", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Shows the server (database) character set encoding."), NULL,
    ...
    {{"unix_socket_group", PGC_POSTMASTER, CONN_AUTH_SETTINGS,
      ...
      gettext_noop("The owning user of the socket is always the user that "
                   "starts the server. "
    ...
    {{"ssl_library", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Shows the name of the SSL library."), NULL,
      GUC_NOT_IN_SAMPLE | GUC_DISALLOW_IN_FILE},
     &ssl_library,
#ifdef USE_SSL
     "OpenSSL",
    ...
    {{"ssl_key_file", PGC_SIGHUP, CONN_AUTH_SSL,
      gettext_noop("Location of the SSL server private key file."), NULL},
     &ssl_key_file,
     "server.key",
     NULL,
     NULL,
    ...
    {{"synchronous_standby_names", PGC_SIGHUP, REPLICATION_PRIMARY,
      gettext_noop("Number of synchronous standbys and list of names of "
                   "potential synchronous ones."),
      NULL, GUC_LIST_INPUT},
     &SyncRepStandbyNames,
     "",
    ...
    {{"cluster_name", PGC_POSTMASTER, PROCESS_TITLE,
      gettext_noop("Sets the name of the cluster, which is included in the "
                   "process title."),
      NULL, GUC_IS_NAME},
     &cluster_name,
     "",
    ...
    {{"wal_consistency_checking", PGC_SUSET, DEVELOPER_OPTIONS,
      gettext_noop("Sets the WAL resource managers for which WAL consistency "
                   "checks are done."),
      gettext_noop("Full-page images will be logged for all data blocks and "
    ...
    {{"backtrace_functions", PGC_SUSET, DEVELOPER_OPTIONS,
      gettext_noop("Log backtrace for errors in these functions."), NULL,
      GUC_NOT_IN_SAMPLE},
     &backtrace_functions,
     "",
    ...
    {{"restrict_nonsystem_relation_kind", PGC_USERSET, CLIENT_CONN_STATEMENT,
      ...
      NULL, GUC_LIST_INPUT | GUC_NOT_IN_SAMPLE},
    ...
    {{"oauth_validator_libraries", PGC_SIGHUP, CONN_AUTH_AUTH,
      gettext_noop("Lists libraries that may be called to validate OAuth v2 "
                   "bearer tokens."),
      NULL, GUC_LIST_INPUT | GUC_LIST_QUOTE | GUC_SUPERUSER_ONLY},
...
struct config_enum ConfigureNamesEnum[] = {
    ...
    {{"compute_query_id", PGC_SUSET, STATS_MONITORING,
      gettext_noop("Enables in-core computation of query identifiers."), NULL},
     &compute_query_id,
    ...
    {{"log_min_error_statement", PGC_SUSET, LOGGING_WHEN,
      gettext_noop("Causes all statements generating error at or above this "
                   "level to be logged."),
      gettext_noop(
          "Each level includes all the levels that follow it. The later"
          " the level, the fewer messages are sent.")},
    ...
    {{"wal_compression", PGC_SUSET, WAL_SETTINGS,
      gettext_noop("Compresses full-page writes written in WAL file with "
                   "specified method."),
      NULL},
     &wal_compression,
    ...
    {{"wal_level", PGC_POSTMASTER, WAL_SETTINGS,
      gettext_noop("Sets the level of information written to the WAL."), NULL},
     &wal_level,
     WAL_LEVEL_REPLICA,
     wal_level_options,
     NULL,
    ...
    {{"shared_memory_type", PGC_POSTMASTER, RESOURCES_MEM,
      gettext_noop("Selects the shared memory implementation used for the main "
    ...
    {{"file_copy_method", PGC_USERSET, RESOURCES_DISK,
      gettext_noop("Selects the file copy method."), NULL},
     &file_copy_method,
    ...
    {{"file_extend_method", PGC_SIGHUP, RESOURCES_DISK,
      gettext_noop("Selects the method used for extending data files."), NULL},
     &file_extend_method,
    ...
    {{"huge_pages", PGC_POSTMASTER, RESOURCES_MEM,
      gettext_noop("Use of huge pages on Linux or Windows."), NULL},
     &huge_pages,
     HUGE_PAGES_TRY,
     huge_pages_options,
     NULL,
    ...
    {{"huge_pages_status", PGC_INTERNAL, PRESET_OPTIONS,
      gettext_noop("Indicates the status of huge pages."), NULL,
      GUC_NOT_IN_SAMPLE | GUC_DISALLOW_IN_FILE},
     &huge_pages_status,
     HUGE_PAGES_UNKNOWN,
    ...
    {{"debug_parallel_query", PGC_USERSET, DEVELOPER_OPTIONS,
      ...
      gettext_noop(
          ...
          "that perform tuple communication between workers and the main "
          "process."),
      GUC_NOT_IN_SAMPLE | GUC_EXPLAIN},
    ...
    {{"password_encryption", PGC_USERSET, CONN_AUTH_AUTH,
      gettext_noop("Chooses the algorithm for encrypting passwords."), NULL},
     &Password_encryption,
    ...
    {{"plan_cache_mode", PGC_USERSET, QUERY_TUNING_OTHER,
      ...
      gettext_noop("Prepared statements can have custom and generic plans, and "
                   "the planner "
                   "will attempt to choose which is better.  This can be set "
                   "to override "
    ...
    {{"ssl_min_protocol_version", PGC_SIGHUP, CONN_AUTH_SSL,
      gettext_noop("Sets the minimum SSL/TLS protocol version to use."), NULL,
      GUC_SUPERUSER_ONLY},
    ...
    {{"ssl_max_protocol_version", PGC_SIGHUP, CONN_AUTH_SSL,
      gettext_noop("Sets the maximum SSL/TLS protocol version to use."), NULL,
      GUC_SUPERUSER_ONLY},
    ...
    {{
         ...
         PGC_SIGHUP,
         ERROR_HANDLING_OPTIONS,
         gettext_noop("Sets the method for synchronizing the data directory "
    ...
    {{"debug_logical_replication_streaming", PGC_USERSET, DEVELOPER_OPTIONS,
      gettext_noop("Forces immediate streaming or serialization of changes in "
                   "large transactions."),
      gettext_noop("On the publisher, it allows streaming or serializing each "
                   "change in logical decoding. "
                   "On the subscriber, it allows serialization of all changes "
                   "to files and notifies the "
                   "parallel apply workers to read and apply them at the end "
                   "of the transaction."),
      GUC_NOT_IN_SAMPLE},
    ...
    {{"io_method", PGC_POSTMASTER, RESOURCES_IO,
      gettext_noop("Selects the method for executing asynchronous I/O."), NULL},
     &io_method,
     DEFAULT_IO_METHOD,
     io_method_options,
     NULL,
